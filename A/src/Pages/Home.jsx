...
import { Container, Card, Button } from '../Components/index'
...
function Home() {
    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50 px-8 py-20">
            ...
            <button className="mt-12 bg-indigo-600 hover:bg-indigo-700 text-white rounded-full px-6 py-3 transition-all"
                onClick={() => authStatus ? navigate("/addpost") : navigate("/login")}
            >
                Get Started
            </button>
        </div>
